...
//
//    for (auto &pair : chunk_mgr->chunks_) {
...
//                    auto block_def = block_mgr->GetBlockById(block.id);
//
//                    if (block_def) {
...
//                            if (block_pstate > 0) {
//                                blockcopy.id = *block_mgr->GetBlockIdByName("powered_conduit");
//                            } else {
//                                blockcopy.id = *block_mgr->GetBlockIdByName("conduit");
//                            }
//                        } else {
